...
func main() {
	username := "admin"                                    // 变换
	token := "593925cfa93135f7ba8b3ed729d537b868724b08"    // 变换
	filehash := "32c5f3673cd3b4dc4bb8bf747103bd120c91e0b3" // 变换
	...
	// 3. 请求分块上传接口
	filename := "C:/Users/11067/Desktop/2025王道操作系统（带书签）.pdf" // 变换
	...
	// 查询文件上传进度
	resp, err = http.Get("http://localhost:8080/file/mpupload/status?" + url.Values{
		"username": {username},
		"token":    {token},
		"uploadid": {uploadID},
	}.Encode())
