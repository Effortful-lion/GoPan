...
func main() {
	...
	// 分块上传接口
	http.HandleFunc("/file/mpupload/init", handler.HTTPInterceptor(handler.InitialMultipartUploasdHandler))
	...
	http.HandleFunc("/file/mpupload/status", handler.HTTPInterceptor(handler.QueryUploadStatusHandler))
