...
func StartConsume(qName, cName string, callback func(msg []byte) bool) {
	...
	err := channel.ExchangeDeclare(
		cfg.Config.RabbitMQConfig.TransExchangeName, // 使用配置中的交换器名称
		"direct", // 交换器类型
		true,     // 持久化
		false,    // 自动删除
		false,    // 内部交换器
	...
	err = channel.QueueBind(
		qName,
		cfg.Config.RabbitMQConfig.TransOSSRoutingKey, // 使用配置中的路由键
		cfg.Config.RabbitMQConfig.TransExchangeName,  // 使用配置中的交换器
		false,
		nil,
	)
	if err != nil {
